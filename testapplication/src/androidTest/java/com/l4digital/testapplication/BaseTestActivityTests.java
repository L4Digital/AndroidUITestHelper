...
/**
 * Base class for any tests that depend on TestActivity.
 */
public abstract class BaseTestActivityTests {
    @Rule
    public L4TestRule<TestActivity> testRule = new L4TestRule<>(TestActivity.class, this);
}
