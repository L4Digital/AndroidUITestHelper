...
public class ScreenshotTaker {
    ...
    public ScreenshotTaker(String saveDir, String screenshotName) {
        mSaveDir = saveDir;
        mScreenshotName = screenshotName;
    }

    public void takeScreenshot() {
        ScreenshotBitmap sb = new ScreenshotBitmap(getDecorView(), getModalView());
        Bitmap screenshotBitmap = sb.createBitmapForScreenshot();
        ScreenshotFile screenshotFile = new ScreenshotFile(mSaveDir, mScreenshotName, screenshotBitmap);
        screenshotFile.saveToDevice();
    }
}